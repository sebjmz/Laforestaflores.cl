...
function cargarPasarelasYAbrirCheckout() {
    if (!pasarelasCargadas) {
        ...
        ppScript.src = 'https://www.paypal.com/sdk/js?client-id=AbfBLeAuXrylWnzDIOQcvpfJwrzBAy0N8281_ip4dFmH1k6H8kW70tPOE_IH6sc05OafIHHfe1PE1Mv1&currency=USD';
        ppScript.onload = () => {
...
function addToCart(id, name, price, img) {
    try {
        ...
        if (atelierBag && !atelierBag.classList.contains('open')) { toggleCart(); }
...
function renderCalendar() {
    ...
    if (mananaCheck.getMonth() !== ahoraChile.getMonth()) { vistaInicial.setMonth(vistaInicial.getMonth() + 1); }
